...
<body class="flex">
    ...
    <div class="sidebar w-64 min-h-screen p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="class_teacher_students.php" class="flex items-center space-x-3 p-3 text-gray-700 hover:bg-gray-100 rounded">
                                ...
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <a href="class_teacher_view_attendance_details.php?date=<?php echo $record['date']; ?>&term=<?php echo $record['term']; ?>&session=<?php echo $record['academic_session']; ?>" 
                                               class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-sm font-semibold transition duration-200">
